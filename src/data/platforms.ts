...
export const platforms: Platform[] = [
  {
    ...
    combinedStatRow: [
      ...
      { value: '3,500+', label: 'Distributors on Platform (TTK Prestige network)' },
  ...
  {
    id: 'finance',
    name: 'BillionTech Finance',
    slug: 'finance',
    tagline: 'Embedded working capital and digital lending.',
    oneLiner: 'BillionTech Finance — embedded working capital and digital lending',
    memberProductSlugs: ['scf', 'billiontech-lend'],
    combinedStatRow: [
      { value: '₹1,500 Cr+', label: 'Platform-Enabled Loans' },
      { value: '100%', label: 'RBI DLD 2025 Compliant (Lend)' },
    ...
    connectingNarrative:
      'SCF and BillionTech Lend sit together because both are regulated-lending-adjacent and both serve BFSI anchors, NBFCs, and banks as the primary buyer — embedded working capital at the point of trade, and a self-hosted LOS with AI credit intelligence for the lender\'s own book.',
